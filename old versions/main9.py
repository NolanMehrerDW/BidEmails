...
# Function to get a user-specified maximum number of emails from the folder, ignoring flagged emails
def get_emails_from_folder(folder, max_emails):
    ...
    for message in messages:
        ...
        try:
            ...
            if not (message.FlagStatus == 1 or message.IsMarkedAsTask):
                ...
                count += 1  # Count unflagged emails
...
if __name__ == "__main__":
    ...
    try:
        max_emails = int(input("What is the maximum number of recent unflagged emails you want to retrieve? "))
    except ValueError:
    ...
    if retrieved_emails:
        ...
        print("No unflagged emails found within the specified criteria.")
